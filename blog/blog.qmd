...
```{html}
<div class='tableauPlaceholder' id='viz1741490048565' style='position: relative'>
  <noscript>
    <a href='#'>
      <img alt='Dashboard Web ' src='https://public.tableau.com/static/images/Sp/SportsBettingWebVersion/DashboardWeb/1_rss.png' style='border: none' />
    </a>
  </noscript>
  <object class='tableauViz' style='display:none;'>
    ...
    <param name='name' value='SportsBettingWebVersion/DashboardWeb' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/Sp/SportsBettingWebVersion/DashboardWeb/1.png' />
