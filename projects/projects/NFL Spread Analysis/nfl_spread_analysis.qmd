...
about:
  ...
  links: 
    - icon: newspaper
      text: "Paper"
      href: https://github.com/brandonowens24/NFL-Count-Modelling/blob/main/project_report.pdf
    - icon: file-earmark-ppt-fill
      text: "Presentation"
      href: https://github.com/brandonowens24/NFL-Count-Modelling/blob/main/NFL_slides.pdf
    - icon: github
      text: "GitHub"
